...
const Dashboard = () => {
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} className="space-y-6">
      <div className="glass p-8 rounded-2xl border border-textMain/10 bg-gradient-to-br from-surface to-surface/50">
      ...
      <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
        {[
          ...
          <div key={i} className="glass rounded-xl p-6 hover:bg-surface/90 transition-colors">
